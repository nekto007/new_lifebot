...
async def cmd_help(message: Message):
    ...
    help_text = (
        ...
        "/tasks — список задач\n\n"
        "<b>Изучение языков:</b>\n"
        "/language_setup — настроить API токен\n"
        "/choose_book — выбрать книгу для чтения\n"
        "/read — читать текущий фрагмент\n"
        "/grammar — последний урок грамматики\n"
        "/audio_schedule — настроить аудио-воркфлоу\n"
        "/language_status — статус Language API\n\n"
        "<b>Делегирование:</b>\n"
